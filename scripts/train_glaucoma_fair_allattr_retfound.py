...
if __name__ == '__main__':
    ...
    if args.model_type in ['vit', 'swin', 'retfound']:
        args.image_size = 224
    ...
    trn_havo_dataset = Harvard_Glaucoma_Fairness_withSplit(args.data_dir, subset='train', split_file=args.split_file, modality_type=args.modality_types, task=args.task, resolution=args.image_size, attribute_type=args.attribute_type, needBalance=args.need_balance, dataset_proportion=args.dataset_proportion, transform=mytransform, dataset=args.dataset, progression_type=args.progression_type)
    tst_havo_dataset = Harvard_Glaucoma_Fairness_withSplit(args.data_dir, subset='test', split_file=args.split_file, modality_type=args.modality_types, task=args.task, resolution=args.image_size, attribute_type=args.attribute_type, dataset=args.dataset
    ...
    if args.modality_types == 'ilm' or args.modality_types == 'rnflt' or \
        args.modality_types == 'slo_fundus':
        in_dim = 1
        if args.model_type != 'retfound':
            ...
            checkpoint_path = "./pretrained/RETFound_cfp_weights.pth"
            ...
            model.patch_embed.proj = nn.Conv2d(1, 1024, kernel_size=(16, 16), stride=(16, 16))
    ...
    for epoch in range(start_epoch, args.epochs):
        train_loss, train_acc, train_auc, trn_preds, trn_gts, trn_attrs = train(model, criterion, optimizer, scaler, train_dataset_loader, epoch, total_iteration, imbalanced_info=imb_info)
        ...
        val_es_acc, val_es_auc, val_aucs_by_attrs, val_dpds, val_eods, between_group_disparity = evalute_comprehensive_perf_(tst_preds, tst_gts, tst_attrs)
