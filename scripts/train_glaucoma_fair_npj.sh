...
PROJECT_DIR=/shared/ssd_28T/home/yl535/project/python/
TASK=cls # md | tds | cls
MODEL_TYPE=( retfound ) # efficientnet | vit | retfound | resnet | swin | vgg | resnext | wideresnet | efficientnetv1 | convnext
...
ATTRIBUTE_TYPE=( gender ) # race gender hispanic race|gender|hispanic|maritalstatus|language
