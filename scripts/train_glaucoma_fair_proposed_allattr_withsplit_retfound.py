...
#     attribute_mapping = {'race':0, 'gender':1, 'hispanic':2}
    ...
    elif args.model_type == 'retfound':
        in_feat_to_final = 1024
...
#             model.patch_embed.proj = nn.Conv2d(1, 1024, kernel_size=(16, 16), stride=(16, 16))
    ...
    if args.model_type == 'vit':
        ...
        final_layer = nn.Linear(in_features=1024, out_features=out_dim, bias=True)
    elif args.model_type == 'efficientnet':
    ...
    if args.model_type != 'retfound':
        ...
        no_weight_decay_list = model[0].no_weight_decay()
        param_groups = param_groups_lrd(model[0], args.weight_decay,
            no_weight_decay_list=no_weight_decay_list,
            layer_decay=args.layer_decay
        )
        optimizer = torch.optim.AdamW(param_groups+
            [{"params": model[1].parameters(), "lr": args.lr}]+[{"params": model[2].parameters(), "lr": args.lr}], lr=args.lr)
